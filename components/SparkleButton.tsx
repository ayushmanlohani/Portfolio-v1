...
.sparkle-button svg:nth-of-type(4) { --x: 75; --y: 60; --s: 0.9; --d: 2; --delay-step: 0.15; }
.sparkle-button svg:nth-of-type(5) { --x: 100; --y: 30; --s: 0.8; --d: 4; --delay-step: 0.15; }
`}</style>
...
export default function SparkleButton(props: Record<string, unknown>) {
  return <__OriginkitBase_SparkleButton {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
